      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {offers.map((offer, index) => (
            <Card key={index} className={`border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-lg ${offer.isSpecial ? 'ring-2 ring-accent/20' : ''}`}>
              ...
              <CardContent className="pt-0">
                ...
                {offer.highlight && (
                  <div className={`p-4 rounded-lg border-l-4 ${offer.isSpecial ? 'bg-accent/10 border-accent' : 'bg-primary/10 border-primary'}`}>
